...
const initialAulas = [
    { id: 1, recursoId: 6, diasSemana: [1, 2, 3, 4, 5], horaInicio: '07:00', horaFim: '21:00', professor: 'Daniel', nome: 'Aula Professor Daniel', status: 'ativo' },
    { id: 2, recursoId: 10, diasSemana: [1, 2, 3, 4, 5], horaInicio: '07:00', horaFim: '21:00', professor: 'Moacyr', nome: 'Aula Professor Moacyr', status: 'ativo' },
    { id: 3, recursoId: 2, diasSemana: [1, 2, 3, 4, 5], horaInicio: '07:00', horaFim: '12:00', professor: 'Xitão', nome: 'Aula Professor Xitão', status: 'ativo' },
    { id: 4, recursoId: 2, diasSemana: [1, 2, 3, 4, 5], horaInicio: '14:00', horaFim: '21:00', professor: 'Xitão', nome: 'Aula Professor Xitão Tarde/Noite', status: 'ativo' },
    { id: 5, recursoId: 6, diasSemana: [6], horaInicio: '07:00', horaFim: '12:00', professor: 'Daniel', nome: 'Aula Sábado Professor Daniel', status: 'ativo' },
    { id: 6, recursoId: 10, diasSemana: [6], horaInicio: '07:00', horaFim: '12:00', professor: 'Moacyr', nome: 'Aula Sábado Professor Moacyr', status: 'ativo' },
    { id: 7, recursoId: 9, diasSemana: [6], horaInicio: '07:00', horaFim: '12:00', professor: 'Xitão', nome: 'Aula Sábado Professor Xitão', status: 'ativo' },
];
