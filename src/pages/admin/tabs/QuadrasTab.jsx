...
export default function QuadrasTab() {
  ...
  return (
    <div className="space-y-4">
            ...
            <Card key={r.id} className="p-3">
              <div className="flex items-center justify-between gap-2">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-slate-500">{mod?.icone} {mod?.nome} · Cap. {r.capacidade}</p>
      ...
      <Modal
        isOpen={modalAberto}
        title={form.id ? 'Editar Quadra' : 'Nova Quadra'}
      ...
      >
        <div className="space-y-4">
          <Select
            ...
            options={modulosOpts}
            error={erros.moduloId}
          />
          <Input
            label="Nome da quadra"
            value={form.nome}
            onChange={e => set('nome', e.target.value)}
            placeholder="Ex: Quadra de Tênis 01"
            error={erros.nome}
          />
          <Input
          ...
          <Input
            ...
            placeholder="Ex: Reforma prevista para junho"
          />
      ...
      >
        <div className="space-y-4">
          <p className="text-slate-600 text-sm">
            Tem certeza que deseja remover esta quadra? As reservas e aulas existentes que referenciam ela podem ficar sem vínculo.
          </p>
